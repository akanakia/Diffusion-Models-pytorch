# -*- coding: utf-8 -*-
# *** indent: 4 spaces ***
"""Diffusion models for image generation tutorial."""
...
class Diffusion:
    ...
    def prepare_noise_schedule(self) -> torch.Tensor:
        """
        Generate a noise schedule tensor using a linear space between beta_start and beta_end.

        Returns
        -------
        torch.Tensor
            A tensor containing the noise schedule values.
        """
